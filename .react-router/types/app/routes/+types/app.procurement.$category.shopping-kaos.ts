...
type Module = typeof import("../app.procurement.$category.shopping-kaos.js")

type Info = GetInfo<{
  file: "routes/app.procurement.$category.shopping-kaos.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.procurement.$category.shopping-kaos.js");
}];
