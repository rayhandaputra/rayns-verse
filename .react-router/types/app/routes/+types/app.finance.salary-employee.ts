...
type Module = typeof import("../app.finance.salary-employee.js")

type Info = GetInfo<{
  file: "routes/app.finance.salary-employee.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.finance.salary-employee.js");
}];
