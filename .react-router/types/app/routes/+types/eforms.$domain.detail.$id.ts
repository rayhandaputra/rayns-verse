...
type Module = typeof import("../eforms.$domain.detail.$id.js")

type Info = GetInfo<{
  file: "routes/eforms.$domain.detail.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../eforms.$domain.js");
}, {
  id: "routes/eforms.$domain.detail.$id";
  module: typeof import("../eforms.$domain.detail.$id.js");
}];
