...
type Module = typeof import("../app.procurement.$category.catalog-color.js")

type Info = GetInfo<{
  file: "routes/app.procurement.$category.catalog-color.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.procurement.$category.js");
}, {
  id: "routes/app.procurement.$category.catalog-color";
  module: typeof import("../app.procurement.$category.catalog-color.js");
}];
