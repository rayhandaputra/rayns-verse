...
type Module = typeof import("../server.drive.$folder_id.download.js")

type Info = GetInfo<{
  file: "routes/server.drive.$folder_id.download.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../server.drive.$folder_id.download.js");
}];
