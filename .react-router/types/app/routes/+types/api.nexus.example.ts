...
type Module = typeof import("../api.nexus.example.js")

type Info = GetInfo<{
  file: "routes/api.nexus.example.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  id: "routes/api.nexus";
  module: typeof import("../api.nexus.js");
}, {
  id: "routes/api.nexus.example";
  module: typeof import("../api.nexus.example.js");
}];
