...
type Module = typeof import("../app.procurement.$category.supplier.js")

type Info = GetInfo<{
  file: "routes/app.procurement.$category.supplier.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.procurement.$category.supplier.js");
}];
