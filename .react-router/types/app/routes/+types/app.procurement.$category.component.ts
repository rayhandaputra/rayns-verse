...
type Module = typeof import("../app.procurement.$category.component.js")

type Info = GetInfo<{
  file: "routes/app.procurement.$category.component.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.procurement.$category.component.js");
}];
