...
type Module = typeof import("../app.procurement.$category.vendor.js")

type Info = GetInfo<{
  file: "routes/app.procurement.$category.vendor.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.procurement.$category.vendor.js");
}];
