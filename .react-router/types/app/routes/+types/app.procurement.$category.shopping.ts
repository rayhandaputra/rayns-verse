...
type Module = typeof import("../app.procurement.$category.shopping.js")

type Info = GetInfo<{
  file: "routes/app.procurement.$category.shopping.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.procurement.$category.shopping.js");
}];
