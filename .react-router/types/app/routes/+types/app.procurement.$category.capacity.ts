...
type Module = typeof import("../app.procurement.$category.capacity.js")

type Info = GetInfo<{
  file: "routes/app.procurement.$category.capacity.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.procurement.$category.capacity.js");
}];
