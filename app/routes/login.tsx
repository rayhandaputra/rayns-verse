  ...
  if (intent === "google") {
    ...
    try {
      ...
      if (result.success && result.token) {
        ...
        return createUserSession(result.token, redirectTo, user);
      }
    ...
    <div className="min-h-screen flex bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="w-full lg:w-2/5 flex items-center justify-center p-6 md:p-12 bg-white relative">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-black text-gray-900 tracking-tight mb-2 font-sans">Login ke Sistem</h1>
            <p className="text-gray-500 font-medium tracking-tight">Silakan masuk ke akun Anda (Admin atau Customer).</p>
          </div>
          ...
          <div className="mb-8">
            <Button
              ...
              className="w-full h-14 rounded-2xl border-gray-100 text-gray-700 hover:bg-gray-50 flex items-center justify-center font-bold transition-all active:scale-[0.98] shadow-sm"
            >
