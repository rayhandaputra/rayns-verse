  ...
  return (
    <>
      ...
      <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
        <nav
          className="w-full max-w-[1450px] bg-white/95 backdrop-blur-md rounded-full shadow-xl shadow-gray-200/60 border border-gray-200"
        >
          <div className="px-6 py-2 sm:px-12">
...
export const Footer = () => {
  ...
  return (
    <>
      ...
      >
        {/* Background watermark text — terpotong setengah di bawah */}
        <div
          aria-hidden
        ...
        >
          ...
          >
            <span style={{ fontSize: "clamp(180px, 28vw, 360px)", }}>K</span>inau.id
          </span>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-16 pb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-14">
            ...
            <div className="md:col-span-4 flex flex-col gap-5">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <h3 className="font-bold text-base text-gray-800">PT Kinau Digital Kreatif</h3>
                <p className="flex flex-col gap-0.5">
                  <span className="font-medium text-gray-400 text-xs uppercase tracking-wider">NIB</span>
                  <span className="font-mono text-gray-700">0204260115049</span>
                </p>
                <p className="flex flex-col gap-0.5">
                  <span className="font-medium text-gray-400 text-xs uppercase tracking-wider">NPWP</span>
                  <span className="font-mono text-gray-700">05.091.550.3-232.3000</span>
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-3">
              <h4 className="font-bold text-gray-800 mb-5 text-sm uppercase tracking-wider">Kontak Kami</h4>
            ...
            <div className="md:col-span-2">
              <h4 className="font-bold text-gray-800 mb-5 text-sm uppercase tracking-wider">Menu Cepat</h4>
            ...
            {/* Sosial Media */}
            <div className="md:col-span-3">
              <h4 className="font-bold text-gray-800 mb-5 text-sm uppercase tracking-wider">Sosial Media</h4>
              <div className="flex flex-col gap-3">
                <a
                  href="https://instagram.com/kinau.id"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-3 text-gray-600 hover:text-pink-600 transition group"
                >
                  <div className="w-10 h-10 rounded-xl bg-white shadow-sm flex items-center justify-center group-hover:bg-pink-50 transition">
                    <Instagram size={18} />
                  </div>
                  <span className="font-medium text-sm">@kinau.id</span>
                </a>
              </div>
            </div>
          </div>
          ...
          {/* Bottom bar */}
          <div className="border-t border-gray-300/60 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-400 pb-20">
            <span>&copy; {new Date().getFullYear()} PT Kinau Digital Kreatif. All rights reserved.</span>
