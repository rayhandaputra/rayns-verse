...
const StockPage: React.FC<StockPageProps> = ({
    ...
    const handleProcessBelanja = () => {
        ...
        submitAction({
            intent: "create_stock_log",
            data: {
                supplier_id: state.selectedShopId,
                                                ...
                                                <ReactSelect
                                                    ...
                                                    value={
                                                        currentShops
                                                            ...
                                                            .find((o) => o.value === state.selectedShopId) ||
                                                        null
                                                    }
                                                    onChange={(val: any) => {
                                                        updateState({
                                                            selectedShopId: val?.value || "",
                                                            restockInputs: {},
                                                        })
                                                        let supCommodities = safeParseArray(val?.supplier_commodities)
                                                        let subComponents = safeParseArray(val?.sub_components)
                                                        setModal({
                                                            ...modal,
                                                            open: true,
                                                            type: "shopping",
                                                            data: {
                                                                ...val,
                                                                supplier_commodities: supCommodities.map((v: any) => ({
                                                                    ...v,
                                                                    sub_components: subComponents.filter((s: any) => +s.parent_id === +v.id)
                                                                }))
                                                            },
                                                        })
                                                    }}
                                                    ...
                                                    classNames={{
                                                        control: () =>
                                                            "!rounded-2xl !border-2 !border-gray-100 !p-2 !text-sm !font-bold focus-within:!border-blue-400 !shadow-none",
                                                        menu: () => "!rounded-2xl !overflow-hidden !border !border-gray-100 !shadow-xl",
                                                        option: ({ isFocused, isSelected }) =>
                                                            `!text-sm !font-bold ${isSelected ? "!bg-blue-600" : isFocused ? "!bg-blue-50 !text-blue-600" : "!bg-white !text-gray-700"}`,
                                                    }}
                                                />
                                                        ...
                                                        <div className="grid grid-cols-1 gap-4">
                                                            {
                                                                ...
                                                                //   )
                                                                safeParseArray(modal?.data?.supplier_commodities)
                                                                    .map((m: any) => (
                                                                        <div
                                                                            key={m.id}
