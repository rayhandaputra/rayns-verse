...
export const isValidUploadedProof = (proof?: unknown) => typeof proof === "string" && proof.includes("data.kinau.id");
...
export const calculateProcurementCosts = (order: Order | undefined, vendor: Supplier | undefined) => {
